...
INSERT INTO security (security_type, id, symbol, expected_return, standard_deviation)
VALUES ('STOCK', 1, 'AAPL', 0.1, 0.5),
       ('STOCK', 2, 'TSLA', 0.2, 0.3),
       ('STOCK', 3, 'NFLX', 0.4, 0.7);

INSERT INTO security (security_type, option_type, id, symbol, expiration, strike, underlying_id)
VALUES ('OPTION', 'PUT', 4, 'AAPL-OCT-2024-110-P', '2024-10-18 11:59:59.999Z', '110', 1),
